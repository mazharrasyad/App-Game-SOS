    ...
    public int PilihPosisi()
    {
        while(true)
        {
            try {
                ...
                System.out.print("Error, Pilih Posisi [0 - 2] : ");
                masuk.next();                                
            }
        }
    }
    ...
    public Papanx3ai()
    {
        ...
        {                  
            ...
            {            
                ...
                do
                {                            
                    System.out.print("Pilih Kolom [0 - 2] : ");
                    kolom = PilihPosisi();
            ...
            else if(giliran == 1)
            {
                ...
                baris = acak.nextInt(3);
                kolom = acak.nextInt(3);                
            }
