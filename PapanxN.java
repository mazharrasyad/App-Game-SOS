    ...
    public int PilihPosisi()
    {
        while(true)
        {
            try {
                ...
                System.out.print("Error, Pilih Posisi [0 - " + n + "] : ");
                masuk.next();                                
            }
        }
    }

    public PapanxN(int n)
    {
        // Membuat Tampilan n x n
        System.out.print("\033[H\033[2J");
        int i, j;        
        String posisi[][] = new String[n][n];   
        ...
        {                  
            // Cek Kotak            
            hitung = 0;            
            System.out.println("Papan " + n + " x " + n + "\n");
            for(i = 0; i < n; i++){   
                System.out.print("\t" + i);
            }
            ...
            do
            {                            
                System.out.print("Pilih Baris [0 - " + n + "] : ");
                baris = PilihPosisi();
            ...
            do
            {                            
                System.out.print("Pilih Kolom [0 - " + n + "] : ");
                kolom = PilihPosisi();
